...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Edit Leave Type</h5> <small class="text-muted float-end"><a  class = "btn btn-sm btn-warning" href="{{ route('create-leave-setup') }}"><i class="fa fa-plus"></i> Add Leave Type</a></small>
      </div>
    <div class="card-body">
        <form id="form" method="post" enctype="multipart/form-data" autocomplete="off" action="{{route('edit-leave-type-process',$id)}}">
            @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="type"   class="form-control" placeholder="Enter Leave Type Name" value="{{ $data->name }}">
